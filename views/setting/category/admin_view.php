...
<div class="survey-category-view">
...
$attributes = [
	...
	[
		...
		'value' => function ($model) {
			...
			return Html::a($instruments, ['setting/instrument/manage', 'category'=>$model->primaryKey, 'publish'=>1], ['title'=>Yii::t('app', '{count} instruments', ['count'=>$instruments])]);
		},
		'format' => 'html',
		'visible' => !$small,
	],
