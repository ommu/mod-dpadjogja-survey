...
$attributes = [
	...
	[
		...
		'value' => $model->service_name ? $model->service_name : '-',
	],
	[
		'attribute' => 'order',
	...
	[
		...
		'value' => function ($model) {
			...
			return Html::a($surveys, ['admin/manage', 'service' => $model->primaryKey, 'publish' => 1], ['title' => Yii::t('app', '{count} surveys', ['count' => $surveys])]);
		},
		'format' => 'html',
		'visible' => !$small,
	],
