 ...
 *
 * This is the model class for table "dpadjogja_survey_work".
 *
 * The followings are the available columns in table "dpadjogja_survey_work":
 * @property integer $id
...
class SurveyWork extends \app\components\ActiveRecord
{
	...
	/**
	 * {@inheritdoc}
	 * @return \dpadjogja\survey\models\query\SurveyWork the active query used by this AR class.
	 */
	public static function find()
	{
		return new \dpadjogja\survey\models\query\SurveyWork(get_called_class());
	}
